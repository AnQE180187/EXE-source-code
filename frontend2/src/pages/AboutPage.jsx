...
const teamMembers = [
  { name: 'Lê Trần Như Thủy', role: 'Leader', imageUrl: 'https://i.pravatar.cc/150?u=an' },
  { name: 'Trần Lê Tú Anh', role: 'Member', imageUrl: 'https://i.pravatar.cc/150?u=anh' },
  { name: 'Lương Gia Khánh', role: 'Member', imageUrl: 'https://i.pravatar.cc/150?u=khanh' },
  { name: 'Lê Anh Khôi', role: 'Member', imageUrl: 'https://i.pravatar.cc/150?u=khoi' },
  { name: 'Hoàng Lê Quý An', role: 'Member', imageUrl: 'https://i.pravatar.cc/150?u=thuy' },
  { name: 'Cao Phan Thanh Phong', role: 'Member', imageUrl: 'https://i.pravatar.cc/150?u=phong' },
];
      ...
      <section className="about-hero">
        <div className="about-hero__content">
          ...
          <p className="about-hero__subtitle">
            Chúng tôi tin rằng mỗi cuối tuần là một cơ hội để tạo nên những kỷ niệm đáng nhớ. FreeDay là nền tảng kết nối bạn với những sự kiện và cộng đồng cùng chung sở thích, biến những ngày nghỉ bình thường trở nên phi thường.
          </p>
        </div>
      </section>
